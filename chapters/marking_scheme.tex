...
Planning Docs (out of 5) & 5 & Project plan, PERT/Gantt charts, risk analysis & \hyperref[sect:planning]{\color{blue}\underline{Chapter \ref*{sect:planning}}} \\
\hline

Planning --- Meeting Notes (out of 5) & 5 & Meeting records, action tracking, team decisions & \hyperref[sect:meeting]{\color{blue}\underline{Chapter \ref*{sect:meeting}}} \\
\hline
...
\noindent
\textbf{Note:} This marking scheme applies to the project team base mark. Individual marks are calculated through peer assessment in accordance with the principles already published for this project.
