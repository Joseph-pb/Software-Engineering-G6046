...
\begin{itemize}
    ...
    \item AI player was scoped down. The AI uses BFS-directed movement toward envelope-candidate rooms and knowledge-filtered suggestions. Full notebook-based deduction (eliminating cards systematically) was not implemented.
...
\begin{enumerate}
    ...
    \item \textbf{Scope-reduction is a valid mitigation.} Cutting some final UI tweaks preserved the time for core features at the cost of nice UI design.
