...
\begin{table}[H]
    ...
    \begin{tabular}{|p{6cm}|l|c|c|c|}
        ...
        Planning, role assignments, sprint plan & All & 19 Feb & 05 Mar & Done \\ \hline
        Design class diagram \& JSON schema & Edward, Ethan & 19 Feb & 05 Mar & Done \\ \hline
        Set up Unity project \& repository & Matt & 05 Mar & 07 Mar & Done \\ \hline
        Establish branching strategy \& workflow doc & Joe & 07 Mar & 07 Mar & Done \\ \hline
        Implement Deck / Card classes & Ben & 08 Mar & 11 Mar & Done \\ \hline
        Implement BoardScript (tile array) & Matt & 08 Mar & 11 Mar & Done \\ \hline
        Implement GameManagerScript (singleton, setup) & Ewan & 11 Mar & 17 Mar & Done \\ \hline
        Implement DiceRollScript (physics) & Ben & 11 Mar & 17 Mar & Done \\ \hline
        Implement TokenMovementScript (movement, pathfinding) & Joe, Ethan & 17 Mar & 15 Apr & Done \\ \hline
        Implement CardGenerator / HandManager / CardInteraction & Matt, Ben & 15 Apr & 17 Apr & Done \\ \hline
        Implement Suggestion / Accusation system & Ewan & 17 Apr & 24 Apr & Done \\ \hline
        Implement AI player (random decision-making) & Ben & 17 Apr & 24 Apr & Done \\ \hline
        Implement GameLoop / turn management & Ewan & 17 Apr & 26 Apr & Done \\ \hline
        System testing \& bug fixing & All & 24 Apr & 28 Apr & Done \\ \hline
        Documentation, report \& submission prep & All & 26 Apr & 30 Apr & Done \\ \hline
    \end{tabular}
    \caption{Final Consolidated Project Tasks and Timeline}
...
\begin{itemize}
    ...
    \item \textbf{Suggestion / Accusation logic merged into existing managers:} In the delivered codebase, the logic lives inside \texttt{GameManagerScript.cs} and \texttt{UiManager.cs} rather than in standalone classes. Splitting the classes cleanly would have required a refactor the team did not have time for (reflected in \texttt{Design/low\_level\_design.md}).
    \item \textbf{AI player scoped down:} The AI uses BFS-directed movement toward envelope-candidate rooms and knowledge-filtered suggestions; full notebook-based deduction (eliminating cards systematically) was not implemented (documented in \texttt{Sprint Docs/sprint\_4.md}).
...
Table \ref{tab:effort} shows the approximate hours per team member per sprint, estimated from Gantt task ownership, sprint-document contributions, and commit history. This justifies the peer-assessment split in \texttt{Group Report/group\_report.md}.
...
Edward & 12 & 18 & 22 & 28 & \textbf{80} \\ \hline
Ewan & 10 & 18 & 18 & 30 & \textbf{76} \\ \hline
Ethan & 12 & 14 & 22 & 22 & \textbf{70} \\ \hline
Joe & 10 & 12 & 22 & 26 & \textbf{70} \\ \hline
Ben & 8 & 14 & 16 & 22 & \textbf{60} \\ \hline
Matt & 10 & 14 & 14 & 22 & \textbf{60} \\ \hline
\textbf{Sprint Total} & \textbf{62} & \textbf{90} & \textbf{114} & \textbf{150} & \textbf{416} \\ \hline
\end{tabular}
\end{table}

\textit{Average $\sim$69 hours per person over the 10-week project ($\sim$7 h/week).}
...
\begin{itemize}
    \item \textbf{Sprint 1:} \textbf{R1} was pre-empted. The team agreed on a Unity LTS version, and Edward seeded the repository with a working scene validated end-to-end. \textbf{R9 materialised} as the team's knowledge gap in Unity and C\# became apparent early on. To mitigate this, time was explicitly allocated in Sprint 1 for tutorials, and members relied heavily on pair-programming with the experienced team member to get up to speed.
    \item \textbf{Sprint 2:} \textbf{R2 materialised} (Unity scene merge conflicts) and \textbf{R1 partially materialised} (incomplete \texttt{.gitignore}). Ethan configured Git LFS, and Edward established Unity Smart Merge settings, PR compile-checks, and \texttt{.gitattributes} for \texttt{.unity} and \texttt{.prefab} files. The issue did not recur.
    \item \textbf{Sprint 3:} \textbf{R3 materialised} (the Easter break effectively paused all development for $\sim$3.5 weeks). \textbf{R4 partially materialised} as TokenMovement was more complex than estimated. The team scoped down TokenMovement, cutting A* pathfinding in favour of legal-move detection (documented in \texttt{Sprint Docs/sprint\_3.md}).
    \item \textbf{Sprint 4:} \textbf{R8 materialised} (GameLoop, Suggestion, and AI were unfinished). \textbf{R4 materialised} via deliberate descoping under pressure. \textbf{R2 re-emerged} during the final integration push. Edward executed a large consolidate merge on 18 April. \textbf{R7} was mitigated by verifying the zip unpacking before the deadline.
\end{itemize}

\textbf{Risks that did not materialise:}
\textbf{R5} (physics dice fallback never triggered an invalid roll) and \textbf{R6} (AI complexity was avoided by choosing a random-decision scope from the start).

\textbf{Lessons for Risk Planning:}
\begin{enumerate}
    ...
    \item \textbf{Scope-reduction is a valid mitigation.} Cutting pathfinding and standalone classes preserved the critical path at the cost of design purity.
...
Cross-references: planning decisions feed \texttt{Planning/gantt\_chart.md} \S3 \textit{Revised Plan}; risk-related decisions feed \texttt{Planning/risk\_analysis.md} \textit{Risk Monitoring}.
\end{quote}
...
Draft initial risk register & Joe / Edward & Yes --- \texttt{risk\_analysis.md} \\ \hline
...
\textbf{Diagrams \& Plans} & Gantt chart (or similar), UML diagram & TBC \\ \hline
...
Begin \texttt{BoardScript} (24x25 tile encoding) & Matt & Sprint 2 & Yes (10/03) \\ \hline
