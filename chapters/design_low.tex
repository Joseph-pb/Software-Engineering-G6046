...
D3 & \texttt{AiPlayer} with basic notebook-based deduction & \texttt{AiPlayer} uses BFS-directed movement and knowledge-filtered suggestions; \texttt{ChooseAccusationFollowUp} returns true when envelope candidates narrow to 3 & Full deduction-based play simplified in Sprint 4; core navigation and knowledge filtering were implemented & \texttt{AiPlayer.cs} --- each method body has a \texttt{TODO (ai)} comment for the upgrade path \\ \hline
